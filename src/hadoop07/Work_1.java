 ...
 * 
 */
public class Work_1 extends Configured implements Tool {
	...
	public static class Reduce extends Reducer<Text, Text, Text, Text> {
		public void reduce(Text key, Iterable<Text> values, Context context)
				throws IOException, InterruptedException {
			if (time == 0) {
				context.write(new Text("deptNo\tdeptName"), new Text("salarys"));
				time++;
			}
			...
			context.write(new Text(key.toString()+"\t"+deptName), new Text(String.valueOf(salarys)));
		}
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(Work_1.class); // 指定Class
	...
	public static void main(String[] args) throws Exception {
		...
		// 运行任务
		int res = ToolRunner.run(new Configuration(), new Work_1(), args);
